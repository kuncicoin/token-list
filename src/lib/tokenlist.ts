...
import tokenlist from './../tokens/kunci.tokenlist.json';
...
export class GitHubTokenListResolutionStrategy {
  repositories = [
    'https://raw.githubusercontent.com/kuncicoin/token-list/main/src/tokens/kunci.tokenlist.json',
  ];
...
export class SolanaTokenListResolutionStrategy {
  repositories = ['https://dist.kunci.network/kunci.tokenlist.json'];
